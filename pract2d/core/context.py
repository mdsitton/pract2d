class Context(object):
    def __init__(self, major, minor, msaa=2):
        ...
        sdl.SDL_GL_SetAttribute(sdl.SDL_GL_CONTEXT_MAJOR, major)
        sdl.SDL_GL_SetAttribute(sdl.SDL_GL_CONTEXT_MINOR, minor)

        sdl.SDL_GL_SetAttribute(sdl.SDL.GL_CONTEXT_PROFILE_MASK, sdl.SDL_GL_CONTEXT_PROFILE_CORE)
